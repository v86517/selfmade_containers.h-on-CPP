...
template <typename T, typename Container> queue<T, Container>::queue() : c_() {}
...
template <typename T, typename Container> queue<T, Container>::~queue() {}
...
template <typename T, typename Container> T &queue<T, Container>::back() {
  return c_.back();
}
...
template <typename T, typename Container> T &queue<T, Container>::front() {
  return c_.front();
}
...
template <typename T, typename Container> void queue<T, Container>::pop() {
  c_.pop_back();
}
