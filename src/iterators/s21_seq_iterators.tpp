...
template <typename T> SequenceIterator<T>::~SequenceIterator() noexcept {}
...
template <typename T>
SequenceIterator<T> &
SequenceIterator<T>::operator=(const SequenceIterator &other) {
  ptr_ = other.ptr_;
  return *this;
}

template <typename T>
ConstSequenceIterator<T> &
ConstSequenceIterator<T>::operator=(const ConstSequenceIterator &other) {
  ptr_ = other.ptr_;
  return *this;
}

template <typename T> T &SequenceIterator<T>::operator*() noexcept {
  return *ptr_;
}
...
template <typename T>
SequenceIterator<T> &
SequenceIterator<T>::operator+=(std::ptrdiff_t diff) noexcept {
  ptr_ += diff;
  return *this;
}
...
template <typename T>
ConstSequenceIterator<T> &
ConstSequenceIterator<T>::operator+=(std::ptrdiff_t diff) noexcept {
  ptr_ += diff;
  return *this;
}
...
template <typename T>
std::ptrdiff_t
SequenceIterator<T>::operator-(const SequenceIterator<T> &other) noexcept {
