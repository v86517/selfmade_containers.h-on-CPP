...
template <typename T, std::size_t N> array<T, N>::array() noexcept {}

template <typename T, std::size_t N> array<T, N>::array(const array &other) {
...
template <typename T, std::size_t N> T &array<T, N>::at(size_t pos) {
  if (pos >= size_) {
...
template <typename T, std::size_t N> T &array<T, N>::operator[](size_t pos) {
  return data_[pos];
}
...
template <typename T, std::size_t N> T &array<T, N>::front() {
  return data_[0];
}

template <typename T, std::size_t N> const T &array<T, N>::front() const {
  return data_[0];
}

template <typename T, std::size_t N> T &array<T, N>::back() {
  return data_[size_ - 1];
}

template <typename T, std::size_t N> const T &array<T, N>::back() const {
  return data_[size_ - 1];
}

template <typename T, std::size_t N> T *array<T, N>::data() noexcept {
  return data_;
}
...
template <typename T, std::size_t N> size_t array<T, N>::size() const noexcept {
  return N;
}
...
template <typename T, std::size_t N> void array<T, N>::fill(const T &value) {
  for (size_t i = 0; i < N; ++i) {
    data_[i] = value;
  }
}
