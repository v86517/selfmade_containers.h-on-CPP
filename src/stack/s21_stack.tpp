...
template <typename T, typename Container> stack<T, Container>::~stack() {}
...
template <typename T, typename Container> T &stack<T, Container>::top() {
  return vector_.back();
}
...
template <typename T, typename Container> void stack<T, Container>::pop() {
  vector_.pop_back();
}
